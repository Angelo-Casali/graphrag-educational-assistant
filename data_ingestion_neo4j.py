...
def main():
    ...
    # Use environment variables from .env file as defaults
    parser.add_argument('--uri',
        default=os.getenv('NEO4J_URI', 'bolt://localhost:7687'),
        help='Neo4j URI (from NEO4J_URI env var)')

    parser.add_argument('--user',
        default=os.getenv('NEO4J_USERNAME') or os.getenv('NEO4J_USER', 'neo4j'),
        help='Neo4j username (from NEO4J_USERNAME or NEO4J_USER env var)')

    parser.add_argument('--password',
        default=os.getenv('NEO4J_PASSWORD'),
        help='Neo4j password (from NEO4J_PASSWORD env var)')

    parser.add_argument('--clear', action='store_true',
        help='Clear the database before import')

    parser.add_argument('--file', default='kg_neuro_neo4j_cleaned.json',
